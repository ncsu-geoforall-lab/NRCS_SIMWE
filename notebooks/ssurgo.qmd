...
%% echo: false
%% eval: true
%% fig-cap: "Flowchart of SSURGO SIMWE workflows"
flowchart TD
...
fig, axes = plt.subplots(
    1, a.shape[0], figsize=(4 * a.shape[0], 4), squeeze=False
)
...
::: {.callout-note}
The runoff depth is divided by the $T_c$-matched storm duration (0.7828 hr = 46.8 min), so the resulting rate corresponds to the 100-year design storm delivered over the watershed's time of concentration.
:::
