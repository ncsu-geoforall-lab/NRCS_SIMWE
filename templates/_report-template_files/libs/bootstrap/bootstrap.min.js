    ...
    : "function" == typeof define && define.amd
                ...
                focusableChildren(t) {
                    const e =
                        [
                            ...
                            "details", "[tabindex]", '[contenteditable="true"]'
      ...
      class st extends H {
          ...
          _handleSwipe() {
              ...
              this._deltaX = 0, e && g(e > 0 ? this._config.rightCallback
      ...
      const ot = ".bs.carousel", rt = ".data-api", at = "next", lt = "prev",
            ...
            gt = `dragstart${ot}`, _t = `load${ot}${rt}`,
            bt = `click${ot}${rt}`, vt = "carousel", yt = "active",
            wt = ".active", At = ".carousel-item", Et = wt + At,
            Tt = {ArrowLeft : ht, ArrowRight : ct}, Ct = {
                interval : 5e3,
                keyboard : !0,
                pause : "hover",
                ride : !1,
      ...
      class xt extends W {
          ...
          _setActiveIndicatorElement(t) {
              ...
              const i = z.findOne(`[data-bs-slide-to="${t}"]`,
                                  this._indicatorsElement);
                     ...
                     function() {
                         Object.keys(e.elements).forEach((function(t) {
                             var n = e.elements[t], s = e.attributes[t] || {},
                                 o = Object
                                         .keys(e.styles.hasOwnProperty(t)
                                                   ? e.styles[t]
                                                   : i[t])
                                         .reduce(
                                             (function(
      ...
      function Te(t, e, i) {
          ...
          var r = (pe(t) ? fe(t) : window).visualViewport, a = !Ee() && i,
              ...
              d = n.height / o;
          return {
              width: h, height: d, top: c, right: l + h, bottom: c + d, left: l,
                  x: l, y: c
          }
      }
      function Ce(t) {
      ...
      function We(t) {
          var e,
              i = t.popper, n = t.popperRect, s = t.placement, o = t.variation,
          ...
          f = g.x, m = g.y;
          var _ = r.hasOwnProperty("x"), b = r.hasOwnProperty("y"), v = Vt,
              y = zt, w = window;
          if (c) {
              ...
              null != e.modifiersData.popperOffsets &&
                  ...
                  null != e.modifiersData.arrow &&
                      (e.styles.arrow = Object.assign(
                           {}, e.styles.arrow, We(Object.assign({}, c, {
      ...
      function ii(t, e) {
          ...
          var i = e, n = i.placement, s = void 0 === n ? t.placement : n,
              ...
              u = void 0 === d ? Jt : d, f = i.altBoundary,
              p = void 0 !== f && f, m = i.padding, g = void 0 === m ? 0 : m,
              _ = Pe("number" != typeof g ? g : Me(g, Qt)),
              b = u === Jt ? Zt : Jt, v = t.rects.popper,
              y = t.elements[p ? b : u],
              w =
                  function(t, e, i, n) {
                  ...
                  return a.width = a.right - a.left,
                         a.height = a.bottom - a.top, a.x = a.left, a.y = a.top,
                         a
      ...
      function ni(t, e) {
          ...
          var i = e, n = i.placement, s = i.boundary, o = i.rootBoundary,
              ...
              d = h ? a ? te : te.filter((function(t) { return Fe(t) === h }))
                             : Qt,
          ...
          hi = {
              ...
              fn : function(t) {
                  var e = t.state, i = t.options, n = t.name, s = i.mainAxis,
                      o = void 0 === s || s, r = i.altAxis,
                      a = void 0 !== r && r, l = i.boundary, c = i.rootBoundary,
                      h = i.altBoundary, d = i.padding, u = i.tether,
                      f = void 0 === u || u, p = i.tetherOffset,
                      m = void 0 === p ? 0 : p, g = ii(e, {
                                                    boundary : l,
                                                    rootBoundary : c,
                                                    padding : d,
                                                    altBoundary : h
                                                }),
                      _ = be(e.placement), b = Fe(e.placement), v = !b,
                      y = Ie(_), w = "x" === y ? "y" : "x",
                      A = e.modifiersData.popperOffsets, E = e.rects.reference,
                      T = e.rects.popper,
                      C = "function" == typeof m
                  ...
                  if (A) {
                      if (o) {
                          var L,
                              ...
                              X = Q ? "y" === y ? Q.clientTop || 0
                                                : Q.clientLeft || 0
                                    : 0,
                              Y = null != (L = null == x ? void 0 : x[y]) ? L
                                                                          : 0,
                              U = I + K - Y,
                              G = Ne(f ? ye(N, I + V - Y - X) : N, I,
                                     f ? ve(P, U) : P);
                          A[y] = G, k[y] = G - I
                      }
                      if (a) {
                          var J,
                              Z = "x" === y ? zt : Vt, tt = "x" === y ? Rt : qt,
                              et = A[w], it = "y" === w ? "height" : "width",
                              nt = et + g[Z], st = et - g[tt],
                              ot = -1 !== [ zt, Vt ].indexOf(_),
                              rt = null != (J = null == x ? void 0 : x[w]) ? J
                                                                           : 0,
                              at =
                                  ot ? nt : et - E[it] - T[it] - rt + O.altAxis,
                              lt =
                                  ot ? et + E[it] + T[it] - rt - O.altAxis : st,
                      ...
                      forceUpdate : function() {
                          if (!c) {
                              ...
                              if (pi(e, i)) {
                                  ...
                                  for (var n = 0; n < a.orderedModifiers.length;
                                       n++)
                                      if (!0 !== a.reset) {
      ...
      class qi extends W {
          ...
          static dataApiKeydownHandler(t) {
              ...
              if (n)
                  return t.stopPropagation(), o.show(),
      ...
      const hn = ".bs.modal", dn = `hide${hn}`, un = `hidePrevented${hn}`,
            ...
            En = "modal-static",
            Tn = {backdrop : !0, focus : !0, keyboard : !0}, Cn = {
      ...
      class cs extends W {
          ...
          show() {
              ...
              if (!this._isWithContent() || !this._isEnabled)
                  return;
              const t = N.trigger(this._element,
          ...
          _setListeners() {
              ...
              for (const e of t)
                  if ("click" === e)
                      ...
                      N.on(
                          this._element, t, this._config.selector, (t => {
                              const e = this._initializeOnDelegatedTarget(t);
                              e._activeTrigger["focusin" === t.type ? os
                                                                    : ss] = !0,
                                                                      e._enter()
                          })),
                          N.on(
                              this._element, i, this._config.selector, (t => {
                                  const e =
              ...
              this._config.smoothScroll &&
                  (N.off(this._config.target, ms),
                   N.on(this._config.target, ms, bs, (t => {
                            const e =
                                this._observableSections.get(t.target.hash);
                            if (e) {
                                t.preventDefault();
      ...
      const
          ...
          Ws = "show", Bs = ":not(.dropdown-toggle)",
          zs =
              '[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]',
          Rs =
              `.nav-link${Bs}, .list-group-item${Bs}, [role="tab"]${Bs}, ${zs}`,
          qs = `.${Fs}[data-bs-toggle="tab"], .${Fs}[data-bs-toggle="pill"], .${
      ...
      class Vs extends W {
          ...
          _getActiveElem() {
              return this._getChildren().find((t => this._elemIsActive(t))) ||
                     null
          }
          ...
          _toggleDropDown(t, e) {
              ...
              n(".dropdown-toggle", Fs), n(".dropdown-menu", Ws),
                  i.setAttribute("aria-expanded", e)
          }
      ...
      const Ks = ".bs.toast", Qs = `mouseover${Ks}`, Xs = `mouseout${Ks}`,
            Ys = `focusin${Ks}`, Us = `focusout${Ks}`, Gs = `hide${Ks}`,
            Js = `hidden${Ks}`, Zs = `show${Ks}`, to = `shown${Ks}`,
            eo = "hide", io = "show", no = "showing", so = {
                animation : "boolean",
                autohide : "boolean",
                delay : "number"
            },
          ...
          show() {
              N.trigger(this._element, Zs).defaultPrevented ||
                  (this._clearTimeout(),
                   ...
                   this._element.classList.remove(eo), d(this._element),
      ...
      return R(ro), m(ro), {
          Alert: Q, Button: Y, Carousel: xt, Collapse: Bt, Dropdown: qi,
              Modal: On, Offcanvas: qn, Popover: us, ScrollSpy: Es, Tab: Vs,
              Toast: ro, Tooltip: cs
      }
  }));
