...
!function(A, e) {
    ...
    globalThis, function() {
        ...
        return function(A) {
            ...
            this.options = A || {}, this.elements = [], u(this.options),
            this.add = function(A) {
 ...
 A.sheet.insertRule(":hover>.anchorjs-link,.anchorjs-link:focus{opacity:1}",
                        A.sheet.cssRules.length),
 A.sheet.insertRule(
 ...
 A.sheet.insertRule(
     ...
     A.sheet.cssRules.length)),
                        ...
                        t = [].map.call(h, function(A) { return A.id }), i = 0;
                        i < e.length; i++)
    ...
    c = document.querySelector("base") ? window.location.pathname +
                                             window.location.search
                                       : "",
    c = this.options.base || c, l.href = c + "#" + o,
    ...
    "left" === this.options.placement ? (l.style.position = "absolute",
                ...
                return e.innerHTML = A, A = e.value,
                ...
                var e = A.firstChild &&
                        -1 < (" " + A.firstChild.className + " ")
                                 .indexOf(" anchorjs-link "),
                    A = A.lastChild && -1 < (" " + A.lastChild.className + " ")
                                                .indexOf(" anchorjs-link ");
                return e || A || !1
            }
        }
