...
const Plugin = () => {
    ...
    function doSearch() {
        ...
        if (matchedSlides) {
            // navigate to the next slide that has the keyword, wrapping to the
            // first if necessary
            ...
            if (matchedSlides.length > currentMatchedIndex) {
                deck.slide(matchedSlides[currentMatchedIndex].h,
        ...
        this.setRegex =
            ...
            if (node.nodeType == 3) { // NODE_TEXT
                ...
                if ((nv = node.nodeValue) && (regs = matchRegex.exec(nv))) {
                    // find the slide's section element and save it in our list
                    // of matching slides
                    var secnode = node;
